...
class TestMetricPerCaseProperties:
    ...
    def test_per_case_compact_label_falls_back_to_display_name_when_short_label_none(self):
        ...
        m = Metric(
            per_case=PerCaseMetric(
                results_column="col",
                mean=MetricSpec(column="col_mean", display_name="Full Display Name", decimal_places=2),
            ),
            aggregate=None,
            rankable=False,
        )
